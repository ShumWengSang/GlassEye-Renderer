...
class LocalHelloTriangleApplication {
 private:
 ...
 private:
  ...
  void createInstance() {
    ...
    // Windows system interface extension
    {
    ...
    {
      // Query number of extensions to allocate array
  ...
  static void framebufferResizeCallback(GLFWwindow* window, int width,
                                        int height) {
    auto app = reinterpret_cast<LocalHelloTriangleApplication*>(
  ...
  void createLogicalDevice() {
    ...
    // Compatiblity with older versions of vulkan
    if (enableValidationLayers) {
      createInfo.enabledLayerCount =
          static_cast<uint32_t>(validationLayers.size());
      createInfo.ppEnabledLayerNames = validationLayers.data();
...
LocalHelloTriangleApplication* app = nullptr;

void Sandbox::HelloTriangleApplication::Init(entt::registry &) {
  app = new LocalHelloTriangleApplication();
}
void Sandbox::HelloTriangleApplication::Shutdown(entt::registry &) {
  delete app;
}
void Sandbox::HelloTriangleApplication::Update(entt::registry &, float dt) {
  app->Update();
}