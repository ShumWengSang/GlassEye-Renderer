...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_QUALIFIER vec<2, T, Q> operator+(vec < 2, T, Q >
    const& v) {
    return
    v;
}
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<2, T, Q> operator+(vec < 1, T, Q >
const& v1,
vec<2, T, Q> const &v2
)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool operator==(vec < 2, T, Q >
const& v1,
vec<2, T, Q> const &v2
)
{
return
detail::compute_equal<T>::call(v1
.x, v2.x) &&
detail::compute_equal<T>::call(v1
.y, v2.y);
}
...
GLM_FUNC_QUALIFIER vec<2, bool, Q> operator&&(vec < 2, bool, Q >
const& v1,
