...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    GLM_FUNC_QUALIFIER mat<4, 3, T, Q>::mat
            (
                    T const &x0, T const &y0, T const &z0, T const &x1, T const &y1, T const &z1, T const &x2
                    , T const &y2, T const &z2, T const &x3, T const &y3, T const &z3
            ) {
    ...
    GLM_FUNC_QUALIFIER mat<4, 3, T, Q>::mat
            (
                    X1 const &x1, Y1 const &y1, Z1 const &z1, X2 const &x2, Y2 const &y2, Z2 const &z2, X3 const &x3
    ...
    GLM_FUNC_QUALIFIER mat<4, 3, T, Q>::mat
            (
                    vec<3, V1, Q> const &v1, vec<3, V2, Q> const &v2, vec<3, V3, Q> const &v3, vec<3, V4, Q> const &v4
            ) {
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_QUALIFIER typename mat<4, 3, T, Q>::col_type const &
