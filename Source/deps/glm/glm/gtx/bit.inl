...
{
return
detail::functor1<L, T, T, Q>::call(highestBitValue, v
);
}
...
{
return
detail::functor1<L, T, T, Q>::call(lowestBitValue, v
);
}
...
{
return
detail::functor1<L, T, T, Q>::call(powerOfTwoAbove, v
);
}
...
{
return
detail::functor1<L, T, T, Q>::call(powerOfTwoBelow, v
);
}
...
{
return
detail::functor1<L, T, T, Q>::call(powerOfTwoNearest, v
);
}
