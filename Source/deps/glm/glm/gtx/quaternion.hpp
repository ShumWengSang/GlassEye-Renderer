...
namespace glm {
    ...
    GLM_FUNC_DECL vec<3, T, Q> cross(
            tquat<T, Q> const &q, vec<3, T, Q> const &v
                                    );
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_DECL vec<3, T, Q> cross(
            vec<3, T, Q> const &v, tquat<T, Q> const &q
                                    );
    ...
    GLM_FUNC_DECL tquat<T, Q> squad(
            tquat<T, Q> const &q1, tquat<T, Q> const &q2, tquat<T, Q> const &s1, tquat<T, Q> const &s2, T const &h
                                   );
    ...
    GLM_FUNC_DECL tquat<T, Q> intermediate(
            tquat<T, Q> const &prev, tquat<T, Q> const &curr, tquat<T, Q> const &next
                                          );
    ...
    GLM_FUNC_DECL vec<4, T, Q> rotate(
            tquat<T, Q> const &q, vec<4, T, Q> const &v
                                     );
    ...
    GLM_FUNC_DECL tquat<T, Q> shortMix(
            tquat<T, Q> const &x, tquat<T, Q> const &y, T const &a
                                      );
