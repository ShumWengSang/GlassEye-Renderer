...
static void handlePointerButton(
        _GLFWwindow *window, int pressed, const MirPointerEvent *pointer_event
                               ) {
...
static void handlePointerMotion(
        _GLFWwindow *window, const MirPointerEvent *pointer_event
                               ) {
...
static void handlePointerEvent(
        const MirPointerEvent *pointer_event, _GLFWwindow *window
                              ) {
