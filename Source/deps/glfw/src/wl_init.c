...
static _GLFWwindow *findWindowFromDecorationSurface(
        struct wl_surface *surface, int *which
                                                   ) {
    int focus;
...
static void keyboardHandleModifiers(
        void *data, struct wl_keyboard *keyboard, uint32_t serial, uint32_t modsDepressed, uint32_t modsLatched
...
static void seatHandleCapabilities(
        void *data, struct wl_seat *seat, enum wl_seat_capability caps
                                  ) {
...
static void dataOfferHandleOffer(
        void *data, struct wl_data_offer *dataOffer, const char *mimeType
                                ) {
}
...
static void dataDeviceHandleDataOffer(
        void *data, struct wl_data_device *dataDevice, struct wl_data_offer *id
                                     ) {
...
static void dataDeviceHandleEnter(
        void *data, struct wl_data_device *dataDevice, uint32_t serial, struct wl_surface *surface, wl_fixed_t x
        , wl_fixed_t y, struct wl_data_offer *id
                                 ) {
}

static void dataDeviceHandleLeave(
        void *data, struct wl_data_device *dataDevice
                                 ) {
}

static void dataDeviceHandleMotion(
        void *data, struct wl_data_device *dataDevice, uint32_t time, wl_fixed_t x, wl_fixed_t y
                                  ) {
}
...
static void wmBaseHandlePing(
        void *data, struct xdg_wm_base *wmBase, uint32_t serial
                            ) {
