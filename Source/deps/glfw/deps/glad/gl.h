...
typedef void (GLAD_API_PTR *PFNGLGETNUNIFORMFVARBPROC)(
...
typedef void (GLAD_API_PTR *PFNGLGETNUNIFORMUIVARBPROC)(
...
typedef void (GLAD_API_PTR *PFNGLSECONDARYCOLORPOINTERPROC)(
