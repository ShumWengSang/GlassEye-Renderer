...
typedef BOOL (CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBA)(
        LPCDIDEVICEINSTANCEA, LPDIRECTINPUTDEVICE8A, DWORD, DWORD, LPVOID
                                                      );

typedef BOOL (CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBW)(
...
DECLARE_INTERFACE_(IDirectInputDeviceA, IUnknown) {
    ...
    STDMETHOD(GetDeviceData)(
            THIS_ DWORD cbObjectData, LPDIDEVICEOBJECTDATA rgdod, LPDWORD pdwInOut, DWORD dwFlags
                            ) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice2A, IDirectInputDeviceA) {
    ...
    STDMETHOD(EnumCreatedEffectObjects)(
            THIS_ LPDIENUMCREATEDEFFECTOBJECTSCALLBACK lpCallback, LPVOID pvRef, DWORD fl
                                       ) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A) {
    ...
    STDMETHOD(WriteEffectToFile)(
            THIS_ LPCSTR lpszFileName, DWORD dwEntries, LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags
                                ) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
    ...
    STDMETHOD(WriteEffectToFile)(
            THIS_ LPCWSTR lpszFileName, DWORD dwEntries, LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags
                                ) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputA, IUnknown) {
    ...
    STDMETHOD(EnumDevices)(
            THIS_ DWORD dwDevType, LPDIENUMDEVICESCALLBACKA lpCallback, LPVOID pvRef, DWORD dwFlags
                          ) PURE;
...
DECLARE_INTERFACE_(IDirectInputW, IUnknown) {
    ...
    STDMETHOD(EnumDevices)(
            THIS_ DWORD dwDevType, LPDIENUMDEVICESCALLBACKW lpCallback, LPVOID pvRef, DWORD dwFlags
                          ) PURE;
...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown) {
    ...
    STDMETHOD(CreateDevice)(
            THIS_ REFGUID rguid, LPDIRECTINPUTDEVICE8A *lplpDirectInputDevice, LPUNKNOWN pUnkOuter
                           ) PURE;
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
    ...
    STDMETHOD(CreateDevice)(
            THIS_ REFGUID rguid, LPDIRECTINPUTDEVICE8W *lplpDirectInputDevice, LPUNKNOWN pUnkOuter
                           ) PURE;
